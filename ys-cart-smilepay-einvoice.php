...
// 外掛常數
define( 'YS_SMILEPAY_VERSION', '1.0.0' );
...
define( 'YS_SMILEPAY_MIN_YS_CART_VERSION', '2.50.0' );
 ...
 * Bootstrap 入口
 *
 * 在 plugins_loaded priority 20 才啟動，以確保 ys-cart 主外掛（priority 10）已完成
 * 自身的 PSR-4 autoloader 註冊與 YSEcommerce singleton 初始化。
 *
